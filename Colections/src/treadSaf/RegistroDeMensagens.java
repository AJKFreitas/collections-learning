...
public class RegistroDeMensagens {
	...
	public static void main(String[] args) throws InterruptedException {
	    ...
	    Thread t1 = new Thread(new ProduzMensagens(0, 100000, mensagens));
	    Thread t2 = new Thread(new ProduzMensagens(100000, 200000, mensagens));
	    Thread t3 = new Thread(new ProduzMensagens(200000, 300000, mensagens));
